/*File "InternetBase.h" create by debial, (Ср 29 мар 2023 12:42:07)*/
...
class InternetBase{
   ...
   InternetBase(Perl *perl_,ServerHandler *handler_)
      : perl(perl_),stdinput(fileno(stdin)),stdflag(false),Handler(handler_){}
